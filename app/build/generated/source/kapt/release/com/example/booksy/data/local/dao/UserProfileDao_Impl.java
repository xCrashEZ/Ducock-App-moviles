...
public final class UserProfileDao_Impl implements UserProfileDao {
  ...
  public UserProfileDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUserProfileEntity = new EntityInsertionAdapter<UserProfileEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `user_profile` (`id`,`name`,`email`,`profileImagePath`,`lastSyncDate`) VALUES (?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getProfileImagePath() == null) {
          ...
          statement.bindString(4, entity.getProfileImagePath());
        }
        statement.bindLong(5, entity.getLastSyncDate());
      }
    };
    this.__preparedStmtOfUpdateProfileImage = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "UPDATE user_profile SET profileImagePath = ? WHERE id = ?";
        return _query;
      }
    };
    this.__preparedStmtOfClearUserProfile = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
  ...
  @Override
  public Object updateProfileImage(final String userId, final String imagePath,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
  ...
  @Override
  public Object clearUserProfile(final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfClearUserProfile.acquire();
        try {
          __db.beginTransaction();
          try {
            _stmt.executeUpdateDelete();
          ...
          __preparedStmtOfClearUserProfile.release(_stmt);
        }
      }
    }, $completion);
  }
      ...
      public UserProfileEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpLastSyncDate;
            _tmpLastSyncDate = _cursor.getLong(_cursorIndexOfLastSyncDate);
            _result = new UserProfileEntity(_tmpId,_tmpName,_tmpEmail,_tmpProfileImagePath,_tmpLastSyncDate);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Object hasUserProfile(final Continuation<? super Boolean> $completion) {
    final String _sql = "SELECT EXISTS(SELECT 1 FROM user_profile)";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
